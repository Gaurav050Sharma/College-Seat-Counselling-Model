...
class Allocation(models.Model):
    ...
    preference_number = models.IntegerField()  # Which preference got allocated (1st, 2nd, etc.)
    ...
    def __str__(self):
        return f"{self.student.user.username} -> {self.course.name} ({self.course.college.name})"
